...
import getCollaterals from '@salesforce/apex/SHF_UnderwriterDecisionCollateral.getCollaterals';
...
export default class ShfUnderwriterdecisioncollateral  extends LightningElement {
    @api applicationId;
