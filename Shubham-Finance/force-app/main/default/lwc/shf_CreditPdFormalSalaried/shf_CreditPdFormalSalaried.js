...
export default class Shf_CreditPdFormalSalaried extends NavigationMixin(LightningElement) {
    @api recordId;
    @api applicationId;
    @api isModalOpen;
    @api isReadOnly;
    ...
    async connectedCallback() {
        ...
        console.log('isRead Id child :', this.isReadOnly);
        try {
    ...
    handleAppOrBrowser() {
        console.log('this.accessMode1234 :');
    ...
    getCurrentLocation() {
        ...
        return new Promise((resolve, reject) => {
            ...
            console.log('getCurrentLocation 11111 ');
    ...
    handleFileChange(event) {
        ...
        reader.onload = () => {
            ...
            // Dispatch event WITH base64 string
    ...
    savePdRecord() {
        console.log('record Id child :', this.recordId);
        console.log('applicationId Id child :', this.applicationId);
    }
